...
const suitableRecipes = recipes.filter((recipe) => {
    const aliceLikes= recipe.ingredients.some((ingredient)=>guest.loves.includes(ingredient))
    const aliceDislikes= recipe.ingredients.some((ingredient)=>guest.dislikes.includes(ingredient))
      return aliceLikes && !aliceDislikes
      }
)
